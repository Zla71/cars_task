...
def export_data(adastra_class_instance, data_frame, time):
    ...
    try:
        ...
        print(f"\n{time} --- The process of exporting data to CSV file was completed..\n")
        print(f"The csv file could be find here: D:\Python\packages\adastra_pack\output.csv\n")
        print(f"The log file could be find here: D:\Python\packages\adastra_pack\log_data.log\n")
