...
def find_top_heaviest_cars(adastra_class_instance, data_frame, time) -> None:
    ...
    try:
        ...
        print()
        write_log.write_logging(f"{time} --- The top 5 most heaviest cars was printed..\n\n")
        write_log.write_logging(f'{adastra_class_instance.heaviest_cars[["Name", "Weight_in_lbs"]]}\n\n')
