...
def find_average_horsepower(adastra_class_instance, data_frame, time) -> str:
    ...
    try:
        ...
        write_log.write_logging(adastra_class_instance, f"{time} --- The average horse power of all the cars was printed..\n")
        write_log.write_logging(adastra_class_instance, f"Average horse power of all the cars: {adastra_class_instance.average_horsepower:.0f} hp\n\n")
